...
(5, 'Harvester Mammoth', 'HM', 'Freighter', 50000, 500, 500, 500, 50, 100, 1000, 7, 'utility', 'The heaviest merchant on the market. Can hold a woping 1000 units of cargo, which makes it a great colonist transporter.', 'fr', 4, 0, 3, 10, 2),
...
(8, 'Skirmisher', 'Skirm', 'Battleship', 200000, 1000, 1000, 2000, 1000, 5000, 0, 0, 'cruiser', 'If its all out war you want, then this is where you''ll get it. This one has everything any warship ever needed. Lots of added extras such as scanner and light stealthing. The neighbours will know when you bring one of these home.', 'sc:ls:bs', 2, 0, 5, 50, 7),
(10, 'Transverser', 'TV', 'Transporter', 250000, 50, 50, 1000, 100, 100, 0, 0, 'advanced', 'Using the latest Sub-space jump technology, this ship can move fleets anywhere in the Cosmos.  Very good ship for large-scale movements, but also uses alot of turns making the jumps.', 'sj', 3, 0, 4, 30, 3),
...
(15, 'Super Skirmisher', 'SSkirm', 'Battleship', 600000, 1000, 1000, 8000, 2000, 8000, 0, 0, 'cruiser', 'A Great ship for getting rid of those pesky enemies, as it has a high fighter capacity, and lots of shields.', 'hs:sh:sc:bs', 5, 1, 6, 60, 7),
(16, 'Mega Miner/Cargo', 'MMC', 'Mega-Flex(tm)', 300000, 100, 100, 2000, 100, 200, 5000, 10, 'utility', 'Vast cargo bays that could house an army of colonists, as well as an exeptional mining rate. If only there were more of them.', 'hs:fr:na', 5, 1, 6, 25, 2),
