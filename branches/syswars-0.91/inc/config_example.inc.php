...
// Please note - this is created automaticly by your installation this is only here if anything happens to the original file, you can see how it is set out.

// SERVER DEFINITIONS
define('MCDB_PATH', dirname(__FILE__) . '/external/mcdb/mcdb.class.php');

// DSN String - type://user:pass@host/database
define('DB_DSN', 'mysql://user:pass@host/database');

define('SE_VERSION', '0.9.13');
